...
function noResults() {
    ...
    modal.setAttribute('class', 'modal rounded-md modal-red p-4');

    var modalContent = document.createElement('div');

    var modalP = document.createElement('p');
    modalP.setAttribute('class', 'modalP rounded-md p-4 text-white');
    modalP.textContent = 'No Results. Try your search again.';
